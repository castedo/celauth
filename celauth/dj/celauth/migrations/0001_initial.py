...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EmailClaim'
        db.create_table(u'celauth_emailclaim', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('openid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['celauth.OpenID'])),
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['celauth.EmailAddress'])),
            ('credible', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'celauth', ['EmailClaim'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EmailClaim'
        db.delete_table(u'celauth_emailclaim')
    ...
    models = {
        ...
        u'celauth.emailclaim': {
            'Meta': {'object_name': 'EmailClaim'},
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'credible': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['celauth.EmailAddress']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'openid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['celauth.OpenID']"})
        },
        u'celauth.openid': {
            'Meta': {'object_name': 'OpenID'},
            'account': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'claimed_id': ('django.db.models.fields.URLField', [], {'max_length': '255', 'primary_key': 'True'}),
            'claims': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['celauth.EmailAddress']", 'through': u"orm['celauth.EmailClaim']", 'symmetrical': 'False'}),
